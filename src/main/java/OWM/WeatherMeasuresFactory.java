...
public class WeatherMeasuresFactory {
    ...
    public WeatherMeasuresFactory(String city, int howManyMeasures) throws FileNotFoundException, APIException {
        this.howManyMeasures=howManyMeasures;
        dataFromOWM=new DataFromOWM(city);
        fillMeasuresist();
    }

    public void fillMeasuresist() throws FileNotFoundException, APIException {
