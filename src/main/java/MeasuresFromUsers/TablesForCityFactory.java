...
public class TablesForCityFactory { //Klasa zawiera metody zwracjące lity konkretnych pomiarów dla wybranego miasta
    ...
    public ArrayList<TemperatureFromUser> showTemperaturesFromUserInCity(int ID, ArrayList<TemperatureFromUser>
    ...
    public ArrayList<PressureFromUser> showPressureFromUserInCity(int ID, ArrayList<PressureFromUser> pressureFromUserArrayList) {
    ...
    public ArrayList<WindSpeedFromUser> showWindSpeedFromUserInCity(int ID, ArrayList<WindSpeedFromUser> windSpeedFromUserArrayList) {
    ...
    public ArrayList<HumidityFromUser> showHumidityFromUserInCity(int ID, ArrayList<HumidityFromUser> humidityFromUserArrayList) {
    ...
    public ArrayList<ClaudinessFromUser> showClaudinessFromUserInCity(int ID, ArrayList<ClaudinessFromUser> claudinessFromUserArrayList) {
